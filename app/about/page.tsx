  ...
  const teamMembers = [
    {
      id: "pranav",
      name: "Pranav Pawar",
      avatar: "/placeholder.svg?height=400&width=400&text=Pranav",
    },
    {
      id: "shriya",
      name: "Shriya Malode",
      avatar: "/placeholder.svg?height=400&width=400&text=Shriya",
    },
    {
      id: "parth",
      name: "Parth Shinde",
      avatar: "/placeholder.svg?height=400&width=400&text=Parth",
    },
    {
      id: "sanyog",
      name: "Sanyog Swami",
      avatar: "/placeholder.svg?height=400&width=400&text=Sanyog",
    },
  ]
                  ...
                  >
                    ...
                    >
                      <div className="text-center">
                        <h3 className={`text-2xl font-bold mb-2 ${activeIndex === index ? "animate-text-glitch" : ""}`}>
                          {member.name}
                        </h3>
                        <div
